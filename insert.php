...
$fetchdata = $database->getReference($ref)->orderByKey()->limitToLast(1)->getValue();

$row = array_shift($fetchdata);
    ...
    <div class="row justify-content-center">
     ...
     <form action="code.php" method="POST" enctype="multipart/form-data"> 
       ...
       <div class="form-group">
        ...
        <div class="form-group">
  <select class="form-control" name="area" id="cities">
	...
	<option value="Zamboanga City">Zamboanga City</option>
        ...
        <div class="form-group">
             <input type="text" required name = "room_number" class="form-control" placeholder="Room Number"/>
        </div>
        ...
        <div class="form-group">
             <input type="number" name = "room_size" class="form-control" placeholder="Room Size SQM"/>
        </div>
        <label>Monthly Rent</label>
        <div class="form-group">
             <input type="number" required name = "monthly_rent" class="form-control" placeholder="Monthly Rent"/>
        </div>
        <label>Commission Sharing</label>
        <div class="form-group">
             <input type="number" required  name = "commission_rate" class="form-control" placeholder="Commission Rate"/>
        </div>
        <label>U+ Realty Commission</label>
        <div class="form-group">
             <input type="number" name = "commission_earn" class="form-control" placeholder="Commission Earn"/>
        </div>
        <p>Contract Start</p>
  
        <div class="form-group">
             <input id="datepicker1" required readonly name = "contract_start" class="form-control" placeholder="Contract Start"/>
        </div>

        <p>Contract End</p>
        <div class="form-group">
             <input id="datepicker2" required readonly name = "contract_end" class="form-control" placeholder="Contract End"/>
        </div>

        <p>Contract Notary</p>
        <div class="form-group">
             <input id="datepicker3" readonly name = "contract_notary" class="form-control" placeholder="Contract Notarize"/>
        </div>
        <p>Commission Collection Date</p>
        <div class="form-group">
             <input id="datepicker4" readonly name = "commission_collection" class="form-control" placeholder="Commission Collection"/>
        </div>
        <label>Broker's Name</label>
        <div class="form-group">
             <input type="text" name = "broker_name" class="form-control" required placeholder="Lessor Broker's Name"/>
        </div>
        <label>Broker's Phone Number</label>
        <div class="form-group">
             <input type="text" name = "broker_phone" class="form-control" placeholder="Lessor Broker's Phone Number"/>
        </div>
        <label>Manager</label>
        <div class="form-group">
             <input type="text" required name = "manager" class="form-control" placeholder="Manager"/>
        </div>
